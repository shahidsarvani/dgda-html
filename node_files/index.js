...
// app.post("/api/room/:id/play_pres/:slide_num", async (req, res) => {
//   let lang = "en";
...
//       clearIntervals();
//     }
//     LogToConsole("Slide Path: " + JSON.stringify(pp_image));
//     if (roomid == process.env.WS_ID) {
//       io.emit("change_video_zone_wsw", pp_image);
//     } else {
//       io.emit("change_video_zone_dw", pp_image);
//       //io.emit("change_video_zone_dp", p_video);
//     }
//     return res.send(apiResponse("Slide Updated on Video Walls"));
//   } catch (err) {
//     return res.send(apiResponseBad(err));
//   }
// });
