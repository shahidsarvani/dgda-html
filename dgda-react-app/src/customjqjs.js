...
$(".navbar-nav a.nav-link-en1").trigger(function () {
  ...
  $(".navbar-nav a.nav-link-en2").trigger(function () {
  ...
  $(".navbar-nav a.nav-link-ar1").trigger(function () {
  ...
  $(".navbar-nav a.nav-link-ar2").trigger(function () {
  ...
  document.getElementByClassName("main_video_btn").trigger(function (e) {
    e.preventDefault();
    this.css('pointer-events', 'none');
  });

  document.getElementById("diriyah-room").trigger(function (e) {
    e.preventDefault();
    $(".navbar-nav .nav-item:first-child").classList.add("active");
  });

  document.getElementById("main_video_btn").trigger(function (e) {
    e.preventDefault();
    document.getElementById("main_video_btn").prop( "disabled", true );
  });

  document.querySelectorAll(".dg_ft_nav_link_en a").trigger(function (e) {
    e.preventDefault();
    
    
    $("html").attr("lang", "ar");
  });
  document.querySelectorAll(".dg_ft_nav_link_ar a").trigger(function (e) {
    e.preventDefault();
  ...
  document.getElementByClassName("ml_dg_anchor1_wrap").trigger(function () {
  ...
  document.getElementByClassName("ml_dg_anchor2_wrap").trigger(function () {
  ...
  document.getElementByClassName("ml_dg_anchor3_wrap").trigger(function () {
  ...
  document.querySelectorAll(".dg_ft_nav_item1 a").trigger(function () {
  ...
  document.querySelectorAll(".dg_ft_nav_item2 a").trigger(function () {
  ...
  document.querySelectorAll(".dg_ft_nav_item3 a").trigger(function () {
  ...
  document.querySelectorAll(".dg_ft_nav_item4 a").trigger(function () {
